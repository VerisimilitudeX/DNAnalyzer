...
/**
 * Searches for curated neurological marker motifs. The motifs are simplified consensus
 * sequences sourced from public literature for demonstrative purposes only.
 */
public final class NeurologicalMarkerAnalyzer {
    private final List<Marker> markers = List.of(
