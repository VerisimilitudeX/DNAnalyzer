...
/**
 * BasePairCounter is Fluent Interface implementation used to count the nucleotides in given dna sequence.
 */
public class BasePairCounter {
    ...
    BasePairCounter countAdenine() {
        adenine = countBasePair(dnaString, intPredicate(DNAAnalysis.AsciiInt.LOWERCASE_A, DNAAnalysis.AsciiInt.UPPERCASE_A));
        return this;
    }
    ...
    BasePairCounter countThymine() {
        thymine = countBasePair(dnaString, intPredicate(DNAAnalysis.AsciiInt.LOWERCASE_T, DNAAnalysis.AsciiInt.UPPERCASE_T));
        return this;
    }
    ...
    BasePairCounter countGuanine() {
        guanine = countBasePair(dnaString, intPredicate(DNAAnalysis.AsciiInt.LOWERCASE_G, DNAAnalysis.AsciiInt.UPPERCASE_G));
        return this;
    }
    ...
    BasePairCounter countCytosine() {
        cytosine = countBasePair(dnaString, intPredicate(DNAAnalysis.AsciiInt.LOWERCASE_C, DNAAnalysis.AsciiInt.UPPERCASE_C));
        return this;
    }
