...
/**
 * Generates quality control statistics for a DNA/FASTQ file.
 * Prints GC content, N base count and mean Phred score then
 * renders a small bar chart showing base distribution.
 */
public class QcStats {
    ...
    /**
     * Returns QC summary as a formatted String.
