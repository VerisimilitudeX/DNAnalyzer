    ...
    try {
      ...
      String requestBody =
          "{\n"
              ...
              + " EXPLAIN THE SIGNIFICANCE OF EVERYTHING, provide the numbers as evidence, and also"
              + " give actionable tasks to the user that they can do to get better/improve what"
              + " they are lacking. Then, answer those questions. Please format it to be outputted"
              + " to the terminal (so no markdown). Do not include or repeat the text that is"
              + " provided to you WITHOUT PROVIDING ADDITIONAL CONTEXT. Dont include the version"
              + " number as the title. Do not use markdown or * symbols in the response as this"
              + " will be outputted to the Terminal/command line."
              + output
              + "\"\n"
              + "        }\n"
              + "    ],\n"
