...
public enum AminoAcid {
  ...
  LEUCINE(
      "Leucine", List.of("l", "leucine", "leu"), List.of("CTT", "CTC", "CTA", "CTG", "TTA", "TTG")),
  ...
  ARGININE(
      "Arginine",
      List.of("r", "arginine", "arg"),
      List.of("CGT", "CGC", "CGA", "CGG", "AGA", "AGG")),
  SERINE(
      "Serine", List.of("s", "serine", "ser"), List.of("TCT", "TCC", "TCA", "TCG", "AGT", "AGC")),
