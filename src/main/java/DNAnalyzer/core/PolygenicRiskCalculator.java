...
/**
 * Utility for calculating polygenic risk scores based on a map of SNP genotypes and a CSV file of
 * weights.
 */
public class PolygenicRiskCalculator {
  ...
  /**
   * Load risk allele weights from a CSV file. The CSV must contain three columns: SNP identifier,
   * risk allele, and numeric weight. Lines starting with '#' are ignored.
   *
  ...
  /**
   * Compute the polygenic risk score using genotype data and allele weights. Each occurrence of the
   * risk allele contributes its weight to the score.
   *
