...
/**
 * Represents a reading frame in a DNA sequence. A reading frame is one of three possible ways to
 * read a DNA sequence as codons, starting from different positions (0, 1, or 2).
 *
 * <p>References: 1. Lewin, B. (2008). Genes IX. Jones & Bartlett Learning. 2. Brown, T. A. (2002).
 * Genomes 2nd edition. Oxford: Wiley-Liss.
 *
 * @version 2.0
 * @since 1.0
 */
public class ReadingFrame {
  ...
  public String toString() {
    return String.format(
        "ReadingFrame{offset=%d, direction=%s, genes=%d}",
        offset, forward ? "forward" : "reverse", genes.size());
  }
  ...
  public boolean equals(Object obj) {
    ...
    return offset == other.offset && forward == other.forward && genes.equals(other.genes);
  }
