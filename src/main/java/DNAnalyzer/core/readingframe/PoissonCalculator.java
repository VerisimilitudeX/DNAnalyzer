...
/**
 * Calculates statistical significance using Poisson distribution. This class provides methods for
 * determining the statistical significance of gene lengths and other sequence features.
 *
 * <p>References: 1. Karlin, S., & Altschul, S. F. (1990). Methods for assessing the statistical
 * significance of molecular sequence features by using general scoring schemes. Proceedings of the
 * National Academy of Sciences, 87(6), 2264-2268.
 *
 * @version 2.0
 * @since 1.0
 */
...
public class PoissonCalculator {
  ...
  /**
   * Calculates the statistical significance of a sequence length using Poisson distribution.
   *
  ...
  /**
   * Calculates the factorial of a number. Uses Stirling's approximation for large numbers to
   * prevent overflow.
   *
