...
/**
 * Represents a potential gene identified in a DNA sequence.
 * This class encapsulates information about a gene's location and statistical significance.
 * 
 * References:
 * 1. Alberts, B., et al. (2014). Molecular Biology of the Cell, 6th Edition
 * 2. Pevzner, P. A. (2000). Computational Molecular Biology: An Algorithmic Approach
 * 
 * @version 2.0
 * @since 1.0
 */
public class PotentialGene {
    ...
    public String toString() {
        return String.format("PotentialGene{start=%d, end=%d, length=%d, significance=%.3f}",
            startPosition,
            endPosition,
            getLength(),
            significance
