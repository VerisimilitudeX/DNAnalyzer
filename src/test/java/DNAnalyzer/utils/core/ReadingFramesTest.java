...
class ReadingFramesTest {
    ...
    /**
     * These are the expected codon counts from .\assets\dna\real\brca1.fa using
     * ReadingFrame 1
     */
    Map<String, Integer> brca1ExpectedFrame1CodonCounts = Map.<String, Integer>ofEntries(
            entry("GCG", 3),
            entry("GCA", 76),
            entry("GCT", 68),
            entry("GCC", 30),
     ...
     * ReadingFrame 2
     */
    Map<String, Integer> brca1ExpectedFrame2CodonCounts = Map.<String, Integer>ofEntries(
            entry("GCG", 5),
            entry("GCA", 38),
            entry("GCT", 17),
            entry("GCC", 15),
     ...
     * ReadingFrame 3
     */
    Map<String, Integer> brca1ExpectedFrame3CodonCounts = Map.<String, Integer>ofEntries(
            entry("GCG", 4),
            entry("GCA", 33),
            entry("GCT", 20),
            entry("GCC", 30),
