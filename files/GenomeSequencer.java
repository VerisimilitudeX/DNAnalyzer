...
public class GenomeSequencer {
    ...
    public void getSequenceAndAminoAcid(ArrayList<String> Isoleucine, ArrayList<String> Leucine,
        ...
        // nucleotides).
        if ((dna.length() == 0) || dna.contains("b") || dna.contains("d") || dna.contains("e") || dna.contains("f")
                || dna.contains("h") || dna.contains("i") || dna.contains("j") || dna.contains("k") || dna.contains("l")
                || dna.contains("m") || dna.contains("n") || dna.contains("o") || dna.contains("p") || dna.contains("q")
                || dna.contains("r") || dna.contains("s") || dna.contains("v") || dna.contains("w") || dna.contains("x")
                || dna.contains("y") || dna.contains("z") || (dna.indexOf(1) >= 0) || (dna.indexOf(2) >= 0)
                || (dna.indexOf(3) >= 0) || (dna.indexOf(4) >= 0) || (dna.indexOf(5) >= 0) || (dna.indexOf(6) >= 0)
                || (dna.indexOf(7) >= 0) || (dna.indexOf(8) >= 0) || (dna.indexOf(9) >= 0) || (dna.indexOf(0) >= 0)
